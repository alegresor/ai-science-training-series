...
if args.device == 'cpu':
    ...
    tf.config.experimental.set_visible_devices(gpus[hvd.local_rank()], 'GPU') # HVD-2

# HVD-3 not applicable
...
opt = tf.optimizers.Adam(args.lr*hvd.size()) # HVD-4
...
def training_step(images, labels):
    ...
    tape = hvd.DistributedGradientTape(tape) # HVD-5
